...
((Drupal) => {
  const { isDesktopNav } = Drupal.opendoor;
  ...
  Drupal.opendoor.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.opendoor.isDesktopNav()) return;
  ...
  Drupal.opendoor.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.opendoor.areAnySubNavsOpen = areAnySubNavsOpen;
