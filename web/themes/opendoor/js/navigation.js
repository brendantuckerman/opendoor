...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.opendoor.areAnySubNavsOpen()) {
          props.opendoor.closeAllSubNav();
        } else {
    ...
    window.addEventListener('resize', () => {
      if (props.opendoor.isDesktopNav()) {
        toggleNav(props, false);
      ...
      Drupal.opendoor.closeAllSubNav();
    });
   ...
   */
  Drupal.behaviors.opendoorNavigation = {
    attach(context) {
