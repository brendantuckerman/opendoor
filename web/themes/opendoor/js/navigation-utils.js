...
((Drupal) => {
  ...
  Drupal.opendoor.isDesktopNav = isDesktopNav;
  ...
  function setStickyHeaderStorage(expandedState) {
    if (!expandedState) {
      localStorage.removeItem('Drupal.opendoor.stickyHeaderState');
      return;
    }
    const now = new Date();
    ...
    localStorage.setItem(
      'Drupal.opendoor.stickyHeaderState',
      JSON.stringify(item),
    );
  }
